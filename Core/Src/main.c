...
static void MX_GPIO_Init(void)
{
    ...
    HAL_GPIO_WritePin(GPIOC, D0_Pin | D1_Pin | D2_Pin | D3_Pin | IN4_Pin | IN3_Pin | IN1_Pin | IN2_Pin, GPIO_PIN_RESET);

    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOA, LED_Pin | D7_Pin | D4_Pin | D5_Pin | D6_Pin, GPIO_PIN_RESET);
    ...
    GPIO_InitStruct.Pin = D0_Pin | D1_Pin | D2_Pin | D3_Pin | IN4_Pin | IN3_Pin | IN1_Pin | IN2_Pin;
    ...
    /*Configure GPIO pins : LED_Pin D7_Pin D4_Pin D5_Pin
                             D6_Pin */
    GPIO_InitStruct.Pin = LED_Pin | D7_Pin | D4_Pin | D5_Pin | D6_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
